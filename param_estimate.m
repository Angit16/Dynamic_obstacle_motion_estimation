...
val = 2924;
filename = '/home/anindya/paper_1_m_files_new/sensor_calibration/range_cal_8.txt';
matR = csvread(filename, 1, 11);
laser_time_inc = 97656.2514552 ;  % time resolution

T1 = readtable('/home/anindya/paper_1_m_files_new/sensor_calibration/range_cal_8.txt', 'ReadVariableNames', false);
start = 2;
for i= start : 528
...
% for i= 1 : 500
%     x_loc(i,1:682) = matR(i,1:682) .* cos((1:682) * theta_res + min_ang );
%     y_loc(i,1:682) = matR(i,1:682) .* sin((1:682) * theta_res + min_ang );
% %     scatter(x_loc(i, 1:682), y_loc(1,1:682));
% %     hold on
% %     z_loc(l,i) = Z0;
% end


T2 = readtable('/home/anindya/paper_1_m_files_new/sensor_calibration/ser_cal_8.txt', 'ReadVariableNames', false);
for i= start : val
    a1(1,i-1) = T2{i,3};
...
% -----------vicon data extract----------
T4 = readtable('/home/anindya/paper_1_m_files_new/sensor_calibration/robo_pose_8.txt', 'ReadVariableNames', false);  % laptop pose
...
filename = '/home/anindya/paper_1_m_files_new/sensor_calibration/ser_cal_8.txt';
...
for l = 1:900
    range4((l-1) * 100 + 1: l * 100) = matR(l,570:669);
    pitch_comp4((l-1) * 100 + 1: l * 100) = laser_pitch(l,570:669);
    theta_comp4((l-1) * 100 + 1: l * 100) = angle(570:669);
end
